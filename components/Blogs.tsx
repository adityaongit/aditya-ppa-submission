...
import { Blog1, Blog2, Blog3 } from "../public/assets/images/index";
import Blog from "./Blog";

const Blogs = () => {
    return (
        <section className="container mt-10 px-5 md:mt-20">
            <h3 className="text-center dark:text-white text-2xl font-semibold !leading-normal text-dark-grey sm:text-3xl md:text-4xl">
